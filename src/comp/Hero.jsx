...
const Hero = () => {
  return (
    <main>
      <div className="bg-[#009191] text-black flex items-start flex-col gap-6 sm:gap-10 min-h-[70vh] justify-center px-5   sm:pl-28 ">
        ...
        <div className="btn text-[14px] sm:text-base text-white hover:text-[#009191] font-light bg-black px-3 py-2 sm:px-5 sm:py-3">
          Explore About Us
        </div>
      </div>
      <div className="text-center mt-[5%] sm:mt-[3%] flex flex-col items-center gap-5 sm:gap-8">
        ...
        />
        <div className="btn">
          <button className="bg-[#009191] whitespace-nowrap text-lg sm:text-xl text-black py-3 sm:py-4 px-8 sm:px-12 rounded-full  font-normal">
            Get Started
          </button>
        </div>
      </div>
